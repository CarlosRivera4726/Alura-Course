...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public void pasarReserva(Reserva reserva) {
		this.txtNreserva.setText(String.valueOf(reserva.getId()));
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				var fechaNacimientoForm = txtFechaN.getDate();
				String nacionalidadForm = txtNacionalidad.getSelectedItem().toString();
				Integer telefonoForm = Integer.parseInt(txtTelefono.getText());
				Integer reservaIDForm = Integer.parseInt(txtNreserva.getText());
				if(nombreForm != null && !nombreForm.isEmpty() && apellidoForm != null && !apellidoForm.isEmpty() 
						   && fechaNacimientoForm != null && nacionalidadForm != null && telefonoForm != null && reservaIDForm != null) {
						    // El formulario está completo
					HuespedController huespedController = new HuespedController();
					Huesped huesped = new Huesped(nombreForm, apellidoForm, new java.sql.Date(fechaNacimientoForm.getTime()), nacionalidadForm, telefonoForm, reservaIDForm);
					huespedController.guardar(huesped);
					JOptionPane.showMessageDialog(null, "El huesped ha sido registrado correctamente con id: " + huesped.getId());
